...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <header<?php print $header_attributes; ?>>
    ...
    <!-- navigation: nodes -->
    <?php if ($prev_node || $next_node): ?>
      <div class="nav-node-container" role="navigation">
        <div class="nav-node-inner">
          <span class="nav-node-prev"><?php if($prev_node): print $prev_node; endif; ?></span>
          <span class="nav-node-next"><?php if($next_node): print $next_node; endif; ?></span>
        </div>
      </div>
    <?php endif; ?>
